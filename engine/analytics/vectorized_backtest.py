...
class VectorBacktester:
    ...
    def plot_overlay(
        ...
        *,
        ...
        # VISUALIZER: matplotlib is imported per-call instead of at module
        # level. This module is on the import path of every backtest run,
        # but the charts live in the browser now — a headless API server
        # should not need a plotting stack to import the engine.
    ...
    def plot(self):
        ...
        # VISUALIZER: see plot_overlay — matplotlib stays a plotting-time
        # dependency, not an import-time one.
        import matplotlib.pyplot as plt
